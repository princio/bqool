...
| Repo               | Role                                              | Consumes          |
|--------------------|---------------------------------------------------|-------------------|
| `backend`          | Core API (NestJS + DB)                            | `bqool`, `runner-types` |
| `runner`           | Standalone AI execution service                   | `bqool`           |
| `frontend`         | Teacher/student UI                                | `bqool`, `backend-types` |
| `bqool`            | Shared domain types                               | —                 |
